    ...
    <div className="w-full flex flex-col pt-2 md:pt-4">
      ...
      <div className="flex justify-between items-start w-full px-2 md:px-6">
        ...
        <div className="flex flex-col items-center gap-1 md:gap-2">
          <h1 className="text-3xl md:text-5xl font-black text-[#3f2a24] text-shadow-sm tracking-widest drop-shadow-md pb-1">
            JUST DIVIDE
          </h1>
          <div className="flex items-center gap-2 text-xl md:text-2xl font-bold text-black font-fredoka pt-1">
        ...
        <button 
          onClick={toggleRules}
          className="bg-emerald-500 rounded-full w-12 h-12 md:w-14 md:h-14 flex items-center justify-center text-white border-2 border-emerald-300 shadow-md transform hover:scale-105 transition-transform"
        >
      ...
      <div className="w-full text-center mt-4 md:mt-6">
        <h2 className="text-[#fd6454] stroke-text-white text-shadow-md text-lg md:text-2xl font-black tracking-wide">
